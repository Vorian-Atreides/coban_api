...
func (s *companiesTestSuite) Test01Get_Companies() {
	expectedCompanies := []databases.Company{
		...
		databases.Company{ID:2, Name:"株式会社愛知銀行", Addresses:[]databases.Address{
			databases.Address{ID:2, Zip:"23106-1", Street:"中区栄3-14-12", City:"名古屋市", CompanyID:2},
		}, Employees:[]databases.User{
			databases.User{ID:2, FirstName:"織田", LastName:"信長", AccountID:2, CompanyID:2},
		}},
		databases.Company{ID:3, Name:"AOCホールディングス株式会社", Addresses:[]databases.Address{
			databases.Address{ID:3, Zip:"140-0002", Street:"品川区東品川二丁目5番8号", City:"東京都", CompanyID:3},
		}, Employees:[]databases.User{
			databases.User{ID:3, FirstName:"豊臣", LastName:"秀吉", AccountID:3, CompanyID:3},
		}},
		databases.Company{ID:4, Name:"旭化成株式会社", Addresses:[]databases.Address{
			databases.Address{ID:4, Zip:"101-8101", Street:"千代田区神田神保町1丁目105番地", City:"東京都", CompanyID:4},
		}, Employees:[]databases.User{
			databases.User{ID:4, FirstName:"徳川", LastName:"家康", AccountID:4, CompanyID:4},
		}},
		databases.Company{ID:5, Name:"株式会社バンダイ", Addresses:[]databases.Address{
			databases.Address{ID:5, Zip:"111-8081", Street:"台東区駒形1丁目4-8", City:"東京都", CompanyID:5},
			databases.Address{ID:6, Zip:"111-8081", Street:"東京都台東区駒形2-5-4", City:"東京都", CompanyID:5},
		}, Employees:[]databases.User{
		}},
	}
